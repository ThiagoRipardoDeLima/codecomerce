CREATE DATABASE `cataglog_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
...
INSERT INTO `cataglog_db`.`categories` (`id`,`name`) VALUES ("6b4c28f4-6831-495a-9444-19c93452faa3","Relogios");
INSERT INTO `cataglog_db`.`categories` (`id`,`name`) VALUES ("7c0ca0d4-ff23-4bd7-b131-c563067c4b43","Eletronicos");
...
INSERT INTO `cataglog_db`.`products` (`id`,`name`,`description`,`price`,`category_id`,`image_url`)
